...
#ifndef GMLEdgeInsets_h
#define GMLEdgeInsets_h
 ...
 */
UIKIT_STATIC_INLINE UIEdgeInsets GMLEdgeInsetsMakeValue(CGFloat value) {
...
/** 设置left、right值 其他为0 */
UIKIT_STATIC_INLINE UIEdgeInsets GMLEdgeInsetsHorizontalValue(CGFloat horizontalValue) {
    return UIEdgeInsetsMake(0, horizontalValue, 0, horizontalValue);
}

/** 设置left、right值 其他为0 */
UIKIT_STATIC_INLINE UIEdgeInsets GMLEdgeInsetsVerticalValue(CGFloat verticalValue) {
    return UIEdgeInsetsMake(verticalValue, 0, verticalValue, 0);
}

/** 计算 left + right */
UIKIT_STATIC_INLINE CGFloat GMLEdgeInsetsGetHorizontal(UIEdgeInsets insets) {
    return insets.left + insets.right;
}

/** 计算 top + bottom */
UIKIT_STATIC_INLINE CGFloat GMLEdgeInsetsGetVertical(UIEdgeInsets insets) {
